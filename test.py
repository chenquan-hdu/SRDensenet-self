...
parser.add_argument('--input_LR_path', type=str, default='D:/project/SRDenseNet-self/data/test/LR/', help='input path to use')
parser.add_argument('--input_HR_path', type=str, default='D:/project/SRDenseNet-self/data/test/HR/', help='input path to use')
parser.add_argument('--model', type=str, default='D:/project/SRDenseNet-self/checkpoint/batchsize=16-SGD/model_epoch_58.pth', help='model file to use')
